...
<div class="container mt-5 mb-4">
    <div class="row justify-content-center">
        <div class="col-md-6 d-flex gap-2 border border-muted rounded px-3 py-2">
            <input type="text" id="search_category" class="form-control border-0 shadow-none" placeholder="Search category...">
...
<div class="container mb-5">
    <div class="row g-4 justify-content-center" id="categories">
        <?php 
        $categories = [
        ...
        foreach ($categories as $category) {
            ...
            <div class='col-6 col-sm-4 col-md-3 col-lg-2'>
                <div class='category-box text-center'>
                    <a class='text-decoration-none' href='getstarted?detail=post-contents'>
...
$(document).ready(function(){
    $('#search_category').on("keyup", function() {
        ...
        $("#categories div").filter(function() {
